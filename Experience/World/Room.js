...
export default class Room {
    ...
    setModel() {
        this.actualRoom.children.forEach((child) => {
            ...
            if (child.name === "Mini_floor") {
                child.position.x = 6.7287;
                child.position.z = 0.141054;
            }
        ...
        rectLight.castShadow = true; // Включение генерации теней
        rectLight.position.set( 8.02134, 8.5, 0);
    ...
    update() {
        ...
        this.mixer.update(this.time.delta * 0.0013)
    }
}
